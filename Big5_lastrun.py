...
notAtAll2 = visual.TextStim(win=win, name='notAtAll2',
    text='Very unlikely',
    font='Times New Roman',
    pos=(-0.27, -0.1), height=0.030, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-1.0);
ExtremelyLikely = visual.TextStim(win=win, name='ExtremelyLikely',
    ...
    languageStyle='LTR',
    depth=-2.0);
rating2 = visual.RatingScale(win=win, name='rating2', marker='triangle', size=1.0, pos=[0.0, -0.4], low=1, high=5, labels=[''], scale='')
unlikely = visual.TextStim(win=win, name='unlikely',
    text='Unlikely',
    font='Times New Roman',
    pos=(-0.13, -0.1), height=0.030, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-5.0);
...
riskPerceptionActivity2 = visual.TextStim(win=win, name='riskPerceptionActivity2',
    ...
    languageStyle='LTR',
    depth=0.0);
rating3 = visual.RatingScale(win=win, name='rating3', marker='triangle', size=1.0, pos=[0.0, -0.4], low=1, high=5, labels=[''], scale='')
notAtAllRisky = visual.TextStim(win=win, name='notAtAllRisky',
    text='Not at all risky',
    font='Times New Roman',
    pos=(-0.3, -0.1), height=0.030, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-2.0);
...
noBenefits = visual.TextStim(win=win, name='noBenefits',
    ...
    languageStyle='LTR',
    depth=-1.0);
rating4 = visual.RatingScale(win=win, name='rating4', marker='triangle', size=1.0, pos=[0.0, -0.4], low=1, high=5, labels=[''], scale='')
...
rating5 = visual.RatingScale(win=win, name='rating5', marker='triangle', size=1.0, pos=[0.0, -0.4], low=1, high=5, labels=[''], scale='')
...
disagreeALittle = visual.TextStim(win=win, name='disagreeALittle',
    text='Disagree\na little',
    font='Times New Roman',
    pos=(-0.15, -0.1), height=0.030, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-4.0);
Neutral = visual.TextStim(win=win, name='Neutral',
...
congratsText = visual.TextStim(win=win, name='congratsText',
    text='Congrats! You have finished all the questions. ',
    font='Times New Roman',
    pos=(0, 0), height=0.1, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
trials_2 = data.TrialHandler(nReps=1, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('AppendixA.xlsx'),
...
for thisTrial_2 in trials_2:
    ...
    rating2.reset()
    # keep track of which components have finished
    riskBehaviorScaleScreen_2Components = [activity, notAtAll2, ExtremelyLikely, rating2, unlikely, neutral, Likely]
...
for thisTrial_3 in trials_3:
    ...
    rating3.reset()
    # keep track of which components have finished
    riskPerceptionActualComponents = [riskPerceptionActivity2, rating3, notAtAllRisky, ModeratelyRisky, ExtremelyRisky]
...
for thisTrial_4 in trials_4:
    ...
    rating4.reset()
    # keep track of which components have finished
    expectedBenefits_2Components = [riskBenefitsScale, noBenefits, rating4, greatBenefits, moderateBenefits]
...
for thisTrial_5 in trials_5:
    ...
    # keep track of which components have finished
    big5Screen_2Components = [rating5, characText, Someone, disagreeStrongly, disagreeALittle, Neutral, AgreeALittle, AgreeStrongly]
...
_key_resp_8_allKeys = []
# keep track of which components have finished
congratsComponents = [congratsText, key_resp_8]
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
congratsClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1
...
while continueRoutine:
    ...
    tThisFlip = win.getFutureFlipTime(clock=congratsClock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
    
    # *congratsText* updates
    if congratsText.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        congratsText.frameNStart = frameN  # exact frame index
        congratsText.tStart = t  # local t and not account for scr refresh
        congratsText.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(congratsText, 'tStartRefresh')  # time at next scr refresh
        congratsText.setAutoDraw(True)
...
for thisComponent in congratsComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
thisExp.addData('congratsText.started', congratsText.tStartRefresh)
thisExp.addData('congratsText.stopped', congratsText.tStopRefresh)
